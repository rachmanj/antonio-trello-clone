...
const MarketingPage = () => {
  return (
    <div className="flex items-center justify-center flex-col">
      ...
      >
        <div className="mb-4 flex items-center border shadow-sm p-4 bg-amber-300 text-amber-800 rounded-full uppercase">
      ...
      >
        Collaborate, manage project and reach new productifity peaks. From high
